<template>
  <nav class="bg-white dark:bg-white">
    <div class="container p-6 mx-auto flex flex-col justify-center">
      <a class="inline-block dark:text-white hover:no-underline flex justify-center" href="/">
        <svg
          class="vmlogo"
          version="1.1"
